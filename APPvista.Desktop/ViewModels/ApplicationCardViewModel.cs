...
public sealed class ApplicationCardViewModel : ObservableObject, IDisposable
{
        ...
        ApplicationCardMetricPreferences metricPreferences)
    {
        ...
        RebuildMetricCards();
        _metricPreferences.PropertyChanged += OnMetricPreferencesPropertyChanged;
    ...
    private void OnMetricPreferencesPropertyChanged(object? sender, System.ComponentModel.PropertyChangedEventArgs e)
    {
        if (_isDisposed)
        {
            return;
