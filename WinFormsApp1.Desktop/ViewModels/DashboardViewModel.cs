...
public sealed partial class DashboardViewModel : ObservableObject
{
    ...
    private readonly SystemOverviewProvider _systemOverviewProvider;
        ...
        string databasePath)
    {
        ...
        _systemOverviewProvider = new SystemOverviewProvider(databasePath);
        ...
        _applicationCardMetricPreferences.PropertyChanged += (_, _) => RebuildApplicationRows();
        ...
        try
        {
            ...
            do
            {
                ...
                var result = await Task.Run(() =>
                {
                    ...
                    var systemOverviewSnapshot = _systemOverviewProvider.Capture(
    ...
    private void SetSystemTotalsDataSource()
    {
        if (_overviewDataSourceMode != OverviewDataSourceMode.SystemTotals)
        {
            ...
            _systemOverviewSnapshot = _systemOverviewProvider.Capture(includeRealtime: true);
            ResetOverviewChartHistory();
            RaiseDisplayStateChanged();
        }
    }
